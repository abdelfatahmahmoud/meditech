<header class="main-header">
    ...
    <div class="header-top">
        <div class="auto-container clearfix">
            ...
            <div class="top-right clearfix">s
    ...
    <div class="btn-group mb-1">
        ...
        <div class="dropdown-menu">
            ...
            @endforeach
                                ...
                                <li class="current dropdown"><a href="#">{{trans('header.Home')}}</a>
                                    <ul>
                                ...
                                <li class="dropdown"><a href="#">{{trans('header.About_us')}}</a>
                                    <ul>
                                ...
                                <li class="dropdown has-mega-menu"><a href="#">{{trans('header.Home')}}</a>
                                    <div class="mega-menu">
                                        <div class="mega-menu-bar row clearfix">
                                            <div class="column col-md-3 col-xs-12">
                                                <h3>{{trans('header.About Us')}}</h3>
                                                <ul>
                                                    <li><a href="about.html">About Us</a></li>
                                                    <li><a href="team.html">Our Team</a></li>
                                                    <li><a href="faq.html">Faq</a></li>
                                ...
                                <li class="dropdown"><a href="#">{{trans('header.Doctors')}}</a>
                                    <ul>
                                        <li><a href="doctors.html">Doctors</a></li>
                                        <li><a href="doctors-detail.html">Doctors Detail</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a href="#">{{trans('header.Department')}}</a>
                                    <ul>
                                        <li><a href="department.html">Department</a></li>
                                        <li><a href="department-detail.html">Department Detail</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a href="#">{{trans('header.Blog')}}</a>
                                    <ul>
                                        <li><a href="blog.html">Our Blog</a></li>
                                        <li><a href="blog-classic.html">Blog Classic</a></li>
                                        <li><a href="blog-detail.html">Blog Detail</a></li>
                                ...
                                <li class="dropdown"><a href="#">{{trans('header.Shop')}}</a>
                                    <ul>
                                        <li><a href="shop.html">Shop</a></li>
                                        <li><a href="shop-single.html">Shop Details</a></li>
                                        <li><a href="shoping-cart.html">Cart Page</a></li>
